...
module.exports = function Home({ user, horoscopes }) {
  ...
  return (
    <Layout user={user}>
      {user ? (
        <div className="gap-y-6 grid grid-cols-4 grid-rows-3 justify-items-center phone:grid-cols-1 phone:grid-rows-12 items-center">
          <Constellation
            label="aries"
            width="300"
            height="280"
      ...
      <>
        <div className="flex flex-col items-center justify-center h-full-body">
          <Constellation
            label="pisces"
            width="300"
            height="280"
            horoscope={findHoroscope("pisces")}
          >
            <Star label="1" y="5" x="40" size="small" color="blue" blur="blur-none" />
            <Star label="2" y="10" x="35" size="small" color="blue" blur="blur-none" />
            <Star label="3" y="15" x="38" size="small" color="blue" blur="blur-none" />
            <Star label="4" y="20" x="45" size="small" color="blue" blur="blur-none" />
            <Star label="5" y="34" x="25" size="big" color="blue" blur="blur-none" />
            <Star label="6" y="55" x="15" size="medium" color="blue" blur="blur-none" />
            <Star label="7" y="70" x="10" size="big" color="blue" blur="blur-none" />
            <Star label="8" y="70" x="25" size="small" color="blue" blur="blur-none" />
            <Star label="9" y="65" x="30" size="small" color="blue" blur="blur-none" />
            <Star label="10" y="63" x="35" size="small" color="blue" blur="blur-none" />
            <Star label="11" y="61" x="40" size="medium" color="blue" blur="blur-none" />
            <Star label="12" y="59" x="46" size="medium" color="blue" blur="blur-none" />
            <Star label="13" y="57" x="50" size="small" color="blue" blur="blur-none" />
            <Star label="14" y="58" x="55" size="small" color="blue" blur="blur-none" />
            <Star label="15" y="63" x="57" size="small" color="blue" blur="blur-none" />
            <Star label="16" y="66" x="53" size="small" color="blue" blur="blur-none" />
            <Star label="17" y="64" x="49" size="small" color="blue" blur="blur-none" />
            <Star label="18" y="62" x="62" size="small" color="blue" blur="blur-none" />
          </Constellation>
          <div className="w-100 mt-12 text-violet-300 text-center">
            <p className="mb-6">This is an application to view your horoscope and enjoy some fun animations. You can register, or, just log in with:</p>
            <p>Email: <strong>test@test.com</strong></p>
            <p className="mb-6">Password: <strong>test1234</strong></p>
            <p>When you're in, hover over or click on the constellations to see what happens.</p>
          </div>
        </div>
      </>}
    </Layout>
